    ...
    function bootstrapController($scope, $location, $route, $routeParams, $templateCache, $http) {
        ...
        $scope.colors = {
            red: [
                ...
                { code: 'red-500', hex: '#F44336', name: 'red-500', textColor: 'text-light' },
                { code: 'red-600', hex: '#E53935', name: 'red-600', textColor: 'text-light' },
                { code: 'red-700', hex: '#D32F2F', name: 'red-700', textColor: 'text-light' },
                { code: 'red-800', hex: '#C62828', name: 'red-800', textColor: 'text-light' },
                { code: 'red-900', hex: '#B71C1C', name: 'red-900', textColor: 'text-light' },
                { code: 'red-a100', hex: '#FF8A80', name: 'red-a100', textColor: 'text-dark' },
                { code: 'red-a200', hex: '#FF5252', name: 'red-a200', textColor: 'text-light' },
                { code: 'red-a400', hex: '#FF1744', name: 'red-a400', textColor: 'text-light' },
                { code: 'red-a700', hex: '#D50000', name: 'red-a700', textColor: 'text-light' },
            ],
