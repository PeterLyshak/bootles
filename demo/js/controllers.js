var myAppControllers = angular.module('myAppControllers', []);
    ...
    myAppControllers.controller('IndexCtrl', ['$scope', '$route', '$routeParams', '$location', '$http',
    ...
    myAppControllers.controller('CssCtrl', ['$scope', '$routeParams',
        function($scope, $routeParams) {
            $scope.pageName = "css";
            // $scope.phoneId = $routeParams.phoneId;
        }]);

    myAppControllers.controller('ComponentsCtrl', ['$scope', '$routeParams',
        function($scope, $routeParams) {
    ...
    myAppControllers.controller('FormCtrl', ['$scope', '$routeParams',
        function($scope, $routeParams) {
            $scope.pageName = "form";
            // $scope.phoneId = $routeParams.phoneId;
        }]);
        
    myAppControllers.controller('FormPepCtrl', ['$scope', '$routeParams',
        function($scope, $routeParams) {
            $scope.pageName = "form-pep";
            // $scope.phoneId = $routeParams.phoneId;
        }]);
    
    myAppControllers.controller('BootstrapCtrl', ['$scope', '$routeParams',
        function($scope, $routeParams) {
    ...
    myAppControllers.controller('ContactCtrl', ['$scope', '$routeParams',
        function($scope, $routeParams) {
